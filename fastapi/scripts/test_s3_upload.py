...
from services.device_manager_service import ESTACOES_METEOROLOGICAS
...
def test_upload_single_station(s3_service):
    ...
    try:
        ...
        resultado = s3_service.upload_todos_csv_estacao(
            data_directory=data_directory, estacao_nome="ARCO_VERDE", anos=["2020"]
        )
    ...
    try:
        ...
        if resultado["total_sucesso"] > 0:
            ...
            for estacao in resultado["estacoes_processadas"]:
                ...
                print(
                    f"  - {estacao}: {detalhe['sucesso']}/{detalhe['total']} arquivos"
                )
